...
(() => {
  ...
  var U = Object.defineProperty, ve = Object.defineProperties,
      Se = Object.getOwnPropertyDescriptor,
      Te = Object.getOwnPropertyDescriptors, Qe = Object.getOwnPropertyNames,
      J = Object.getOwnPropertySymbols, Ee = Object.getPrototypeOf,
  ...
  var we = (t, e, r, n) => {
    if (e && typeof e == "object" || typeof e == "function")
      for (let i of Qe(e))
        !Z.call(t, i) && i !== r &&
            U(t, i,
              {get : () => e[i], enumerable : !(n = Se(e, i)) || n.enumerable});
    return t
  };
  ...
  var re = Le(
      (ee, te) => {
           ...
           * not as bright - 2.3.9 Copyright (C) 2020 Oliver Nightingale
           * @license MIT
           */
          (function() {
            var t = function(e) {
              ...
              return r.pipeline.add(t.trimmer, t.stopWordFilter, t.stemmer),
                     r.searchPipeline.add(t.stemmer), e.call(r, r), r.build()
            };
            t.version = "2.3.9"; /*!
                                  * lunr.utils
            ...
            t.utils = {}, t.utils.warn = function(e) {
              return function(
                  r) { e.console && console.warn && console.warn(r) }
            }(this), t.utils.asString = function(e) {
              return e == null ? "" : e.toString()
            }, t.utils.clone = function(e) {
              if (e == null)
                return e;
              for (var r = Object.create(null), n = Object.keys(e), i = 0;
                   i < n.length; i++) {
                var s = n[i], o = e[s];
                if (Array.isArray(o)) {
                  r[s] = o.slice();
            ...
            t.Set.prototype.contains = function(
                e) { return !!this.elements[e] },
            t.Set.prototype.intersect = function(e) {
              ...
              return e === t.Set.complete ? t.Set.complete
                     : e === t.Set.empty
                         ? this
                         : new t.Set(Object.keys(this.elements)
                                         .concat(Object.keys(e.elements)))
            }, t.idf = function(e, r) {
              var n = 0;
              for (var i in e)
              ...
              return e = e || function(r) { return r },
            ...
            t.tokenizer =
              ...
              if (Array.isArray(e))
                return e.map(function(g) {
                  return new t.Token(t.utils.asString(g).toLowerCase(),
                                     t.utils.clone(r))
                });
              for (var n = e.toString().toLowerCase(), i = n.length, s = [],
                       o = 0, a = 0;
                   o <= i; o++) {
                ...
                if (u.match(t.tokenizer.separator) || o == i) {
                  if (c > 0) {
                    ...
                    f.position = [ a, c ], f.index = s.length,
            ...
            t.tokenizer.separator =
                /[\s\-]+/; /*!
                            ...
                            * Copyright (C) 2020 Oliver Nightingale
                            */
            t.Pipeline = function() { this._stack = [] },
            t.Pipeline.registeredFunctions = Object.create(null),
            t.Pipeline.registerFunction = function(e, r) {
              r in this.registeredFunctions &&
                  t.utils.warn("Overwriting existing registered function: " +
                               r),
                  e.label = r, t.Pipeline.registeredFunctions[e.label] = e
...
`,
              ...
              return this.run([ n ]).map(function(i) { return i.toString() })
            ...
            t.Vector.prototype.positionForIndex = function(e) {
              if (this.elements.length == 0)
                return 0;
              for (var r = 0, n = this.elements.length / 2, i = n - r,
                       s = Math.floor(i / 2), o = this.elements[s * 2];
              ...
              this.upsert(e, r, function() { throw "duplicate index" })
              ...
              for (var r = 0, n = this.elements, i = e.elements, s = n.length,
                       o = i.length, a = 0, u = 0, c = 0, f = 0;
                   c < s && f < o;)
                a = n[c], u = i[f],
                a < u   ? c += 2
                : a > u ? f += 2
              ...
              for (var e = new Array(this.elements.length / 2), r = 1, n = 0;
                   r < this.elements.length; r += 2, n++)
                e[n] = this.elements[r];
              return e
            ...
            t.stemmer =
              ...
              var e = {
                ...
                logi : "log"
                  ...
                  n = "[^aeiou]", i = "[aeiouy]", s = n + "[^aeiouy]*",
                  o = i + "[aeiou]*", a = "^(" + s + ")?" + o + s,
                  u = "^(" + s + ")?" + o + s + "(" + o + ")?$",
                  c = "^(" + s + ")?" + o + s + o + s, f = "^(" + s + ")?" + i,
                  g = new RegExp(a), l = new RegExp(c), m = new RegExp(u),
                  x = new RegExp(f), v = /^(.+?)(ss|i)es$/,
                  d = /^(.+?)([^s])s$/, y = /^(.+?)eed$/, b = /^(.+?)(ed|ing)$/,
                  E = /.$/, w = /(at|bl|iz)$/,
                  ...
                  M = function(h) {
                    ...
                    if (h.length < 3)
                      return h;
                    if (L = h.substr(0, 1),
                        L == "y" && (h = L.toUpperCase() + h.substr(1)), p = v,
                        T = d,
                        p.test(h) ? h = h.replace(p, "$1$2")
                      ...
                      var Q = T.exec(h);
                      S = Q[1], T = x,
                      T.test(S) && (h = S, T = w, O = R, F = j,
                                    T.test(h)   ? h = h + "e"
                                    : O.test(h) ? (p = E, h = h.replace(p, ""))
                                                : F.test(h) && (h = h + "e"))
                    }
                    if (p = _, p.test(h)) {
                      var Q = p.exec(h);
                    ...
                    return p = z, T = l,
                           p.test(h) && T.test(h) &&
                               (p = E, h = h.replace(p, "")),
                           L == "y" && (h = L.toLowerCase() + h.substr(1)), h
                  };
              return function(I) { return I.update(M) }
            }(),
            ...
            t.generateStopWordFilter =
                function(e) {
              var r = e.reduce(function(n, i) { return n[i] = i, n }, {});
              return function(n) {
            ...
            t.trimmer =
              ...
              return e.update(function(
                  r) { return r.replace(/^\W+/, "").replace(/\W+$/, "") })
            },
            t.Pipeline.registerFunction(
                t.trimmer, "trimmer"); /*!
                                        * lunr.TokenSet
                                        ...
                                        */
            t.TokenSet = function() {
              this.final = !1, this.edges = {}, this.id = t.TokenSet._nextId,
              t.TokenSet._nextId += 1
            }, t.TokenSet._nextId = 1, t.TokenSet.fromArray = function(e) {
              for (var r = new t.TokenSet.Builder, n = 0, i = e.length; n < i;
                   n++)
                r.insert(e[n]);
              ...
              for (var n = new t.TokenSet,
                       i = [ {node : n, editsRemaining : r, str : e} ];
                   i.length;) {
                var s = i.pop();
                if (s.str.length > 0) {
                  var o = s.str.charAt(0), a;
                  o in s.node.edges ? a = s.node.edges[o]
              ...
              for (var r = new t.TokenSet, n = r, i = 0, s = e.length; i < s;
                   i++) {
                var o = e[i], a = i == s - 1;
                if (o == "*")
              ...
              for (var e = this.final ? "1" : "0",
                       r = Object.keys(this.edges).sort(), n = r.length, i = 0;
                   i < n; i++) {
              ...
              for (var r = new t.TokenSet, n = void 0,
                       i = [ {qNode : e, output : r, node : this} ];
                   i.length;) {
                n = i.pop();
                for (var s = Object.keys(n.qNode.edges), o = s.length,
                         a = Object.keys(n.node.edges), u = a.length, c = 0;
                     c < o; c++)
                  for (var f = s[c], g = 0; g < u; g++) {
                    var l = a[g];
                    if (l == f || f == "*") {
                      var m = n.node.edges[l], x = n.qNode.edges[f],
                          v = m.final && x.final, d = void 0;
                      l in n.output.edges
                          ? (d = n.output.edges[l], d.final = d.final || v)
                          : (d = new t.TokenSet, d.final = v,
                             n.output.edges[l] = d),
              ...
              this.minimize(n),
                  this.uncheckedNodes.length == 0
                      ? r = this.root
                      : r = this.uncheckedNodes[this.uncheckedNodes.length - 1]
                                .child;
            ...
            t.Index = function(e) {
              ...
              this.fieldVectors = e.fieldVectors, this.tokenSet = e.tokenSet,
              this.fields = e.fields, this.pipeline = e.pipeline
              ...
              for (var r = new t.Query(this.fields), n = Object.create(null),
              ...
              for (var u = 0; u < r.clauses.length; u++) {
                ...
                for (var l = 0; l < f.length; l++) {
                  ...
                  for (var b = 0; b < v.length; b++)
                    for (var E = v[b], w = this.invertedIndex[E], R = w._index,
                             d = 0;
                         d < c.fields.length; d++) {
                      var y = c.fields[d], j = w[y], _ = Object.keys(j),
                          D = E + "/" + y, N = new t.Set(_);
                      ...
                      if (i[y].upsert(R, c.boost,
                                      function(ye, me) { return ye + me }),
                          !s[D]) {
              ...
              for (var M = t.Set.complete, I = t.Set.empty, u = 0;
                   u < this.fields.length; u++) {
                var y = this.fields[u];
              ...
              for (var u = 0; u < h.length; u++) {
                ...
                if (M.contains(p) && !I.contains(p)) {
                  var T = this.fieldVectors[L],
                      O = i[L.fieldName].similarity(T), F;
                  if ((F = k[p]) !== void 0)
              ...
              return S.sort(function(pe, ge) { return ge.score - pe.score })
              ...
              return {
                version: t.version, fields: this.fields, fieldVectors: r,
                    invertedIndex: e, pipeline: this.pipeline.toJSON()
              }
            }, t.Index.load = function(e) {
              var r = {}, n = {}, i = e.fieldVectors, s = Object.create(null),
                  o = e.invertedIndex, a = new t.TokenSet.Builder,
                  u = t.Pipeline.load(e.pipeline);
              e.version != t.version &&
                  t.utils.warn(
                      "Version mismatch when loading serialised index. Current version of lunr '" +
                      t.version + "' does not match serialized index '" +
                      e.version + "'");
              ...
              return a.finish(), r.fields = e.fields, r.fieldVectors = n,
                                 r.invertedIndex = s, r.tokenSet = a.root,
                                 r.pipeline = u, new t.Index(r)
            }; /*!
                * lunr.Builder
                * Copyright (C) 2020 Oliver Nightingale
                */
            t.Builder =
              ...
              this.tokenizer = t.tokenizer, this.pipeline = new t.Pipeline,
              this.searchPipeline = new t.Pipeline, this.documentCount = 0,
              this._b = .75, this._k1 = 1.2, this.termIndex = 0,
              this.metadataWhitelist = []
            },
            t.Builder.prototype.ref = function(e) { this._ref = e },
            t.Builder.prototype.field =
                function(e, r) {
              if (/\//.test(e))
            ...
            t.Builder.prototype.b = function(
                e) { e < 0   ? this._b = 0
                     : e > 1 ? this._b = 1
                             : this._b = e },
            t.Builder.prototype.k1 = function(e) { this._k1 = e },
            t.Builder.prototype.add =
                function(e, r) {
              var n = e[this._ref], i = Object.keys(this._fields);
              this._documents[n] = r || {}, this.documentCount += 1;
              for (var s = 0; s < i.length; s++) {
                var o = i[s], a = this._fields[o].extractor,
                    u = a ? a(e) : e[o],
                    c = this.tokenizer(u, {fields : [ o ]}),
                    f = this.pipeline.run(c), g = new t.FieldRef(n, o),
                    l = Object.create(null);
                this.fieldTermFrequencies[g] = l, this.fieldLengths[g] = 0,
                this.fieldLengths[g] += f.length;
                for (var m = 0; m < f.length; m++) {
                  var x = f[m];
                  if (l[x] == null && (l[x] = 0), l[x] += 1,
            ...
            t.Builder.prototype.calculateAverageFieldLengths =
              ...
              for (var e = Object.keys(this.fieldLengths), r = e.length, n = {},
                ...
                i[a] || (i[a] = 0), i[a] += 1, n[a] || (n[a] = 0),
                    n[a] += this.fieldLengths[o]
              }
              for (var u = Object.keys(this._fields), s = 0; s < u.length;
                   s++) {
                var c = u[s];
                n[c] = n[c] / i[c]
              }
            ...
            t.Builder.prototype.createFieldVectors =
                function() {
              for (var e = {}, r = Object.keys(this.fieldTermFrequencies),
                       n = r.length, i = Object.create(null), s = 0;
                   s < n; s++) {
                for (var o = t.FieldRef.fromString(r[s]), a = o.fieldName,
                         u = this.fieldLengths[o], c = new t.Vector,
                         f = this.fieldTermFrequencies[o], g = Object.keys(f),
                         l = g.length, m = this._fields[a].boost || 1,
                         x = this._documents[o.docRef].boost || 1, v = 0;
                     v < l; v++) {
                  var d = g[v], y = f[d], b = this.invertedIndex[d]._index, E,
                      w, R;
                  i[d] === void 0
                      ...
                      : E = i[d],
                        w = E * ((this._k1 + 1) * y) /
                            (this._k1 *
                             ...
                             y),
                        w *= m, w *= x, R = Math.round(w * 1e3) / 1e3,
                        c.insert(b, R)
                }
                e[o] = c
              }
            ...
            t.Builder.prototype.createTokenSet =
                function() {
              this.tokenSet =
                  t.TokenSet.fromArray(Object.keys(this.invertedIndex).sort())
            },
            t.Builder.prototype.build =
                function() {
            ...
            t.MatchData =
                function(e, r, n) {
              for (var i = Object.create(null), s = Object.keys(n || {}), o = 0;
                   o < s.length; o++) {
                var a = s[o];
                i[a] = n[a].slice()
              }
                ...
                for (var o = 0; o < s.length; o++) {
                  ...
                  for (var c = 0; c < u.length; c++) {
                    ...
                    this.metadata[i][a][f] == null
                        ...
                        : this.metadata[i][a][f] =
                              this.metadata[i][a][f].concat(e.metadata[i][a][f])
                  }
                }
              }
            },
            t.MatchData.prototype.add =
                function(e, r, n) {
              ...
              for (var i = Object.keys(n), s = 0; s < i.length; s++) {
                ...
                o in this.metadata[e][r]
                    ? this.metadata[e][r][o] =
                          this.metadata[e][r][o].concat(n[o])
                    : this.metadata[e][r][o] = n[o]
              }
            },
            t.Query = function(e) { this.clauses = [], this.allFields = e },
            t.Query.wildcard = new String("*"), t.Query.wildcard.NONE = 0,
            t.Query.wildcard.LEADING = 1, t.Query.wildcard.TRAILING = 2,
            t.Query.presence = {OPTIONAL : 1, REQUIRED : 2, PROHIBITED : 3},
            t.Query.prototype.clause =
                function(e) {
            ...
            t.Query.prototype.term =
                function(e, r) {
              if (Array.isArray(e))
                return e.forEach(function(i) { this.term(i, t.utils.clone(r)) },
                                 this),
                       this;
              var n = r || {};
            ...
            t.QueryParseError =
                function(e, r, n) {
              this.name = "QueryParseError", this.message = e, this.start = r,
              this.end = n
            },
            ...
            t.QueryLexer =
              ...
              this.pos = 0, this.start = 0, this.escapeCharPositions = []
            },
            ...
            t.QueryLexer.prototype.sliceString =
                function() {
              for (var e = [], r = this.start, n = this.pos, i = 0;
                   i < this.escapeCharPositions.length; i++)
                n = this.escapeCharPositions[i], e.push(this.str.slice(r, n)),
                r = n + 1;
              return e.push(this.str.slice(r, this.pos)),
                     this.escapeCharPositions.length = 0, e.join("")
            },
            t.QueryLexer.prototype.emit =
                function(e) {
              this.lexemes.push({
                type : e,
            ...
            t.QueryLexer.prototype.backup = function() { this.pos -= 1 },
            ...
            t.QueryLexer.EOS = "EOS", t.QueryLexer.FIELD = "FIELD",
            t.QueryLexer.TERM = "TERM",
            t.QueryLexer.EDIT_DISTANCE = "EDIT_DISTANCE",
            t.QueryLexer.BOOST = "BOOST", t.QueryLexer.PRESENCE = "PRESENCE",
            t.QueryLexer.lexField =
                function(e) {
              return e.backup(), e.emit(t.QueryLexer.FIELD), e.ignore(),
                     t.QueryLexer.lexText
            },
            t.QueryLexer.lexTerm =
                function(e) {
              if (e.width() > 1 && (e.backup(), e.emit(t.QueryLexer.TERM)),
                  e.ignore(), e.more())
                return t.QueryLexer.lexText
            },
            t.QueryLexer.lexEditDistance =
                function(e) {
              return e.ignore(), e.acceptDigitRun(),
                     e.emit(t.QueryLexer.EDIT_DISTANCE), t.QueryLexer.lexText
            },
            t.QueryLexer.lexBoost =
                function(e) {
              return e.ignore(), e.acceptDigitRun(), e.emit(t.QueryLexer.BOOST),
                     t.QueryLexer.lexText
            },
            t.QueryLexer.lexEOS = function(
            ...
            t.QueryLexer.lexText = function(e) {
              for (;;) {
                ...
                if (r == "~")
                  return e.backup(), e.width() > 0 && e.emit(t.QueryLexer.TERM),
                         t.QueryLexer.lexEditDistance;
                if (r == "^")
                  return e.backup(), e.width() > 0 && e.emit(t.QueryLexer.TERM),
                         t.QueryLexer.lexBoost;
              ...
              this.lexer = new t.QueryLexer(e), this.query = r,
  ...
  function ke(t, e = document) { return e.querySelector(t) || void 0 }
               ...
               for (let r = t.length - 1; r >= 0; r--) {
                 ...
                 typeof n == "string"
                     ...
                     : n.parentNode && n.parentNode.removeChild(n),
                       r ? e.insertBefore(this.previousSibling, n)
  ...
  function se(t, e) {
    ...
    for (let s = 0; i < t.length; i++)
      t.charAt(i) === "<" && i > n
          ? e(r, 1, n, n = i)
          : t.charAt(i) === ">" &&
                (t.charAt(n + 1) === "/" ? --s === 0 && e(r++, 2, n, i + 1)
                                         : t.charAt(i - 1) !== "/" &&
                                               s++ === 0 && e(r, 0, n, i + 1),
                 n = i + 1);
    i > n && e(r, 1, n, i)
  }
  function oe(t, e, r, n = !1) { return q([ t ], e, r, n).pop() }
  function q(t, e, r, n = !1) {
    let i = [ 0 ];
    for (let s = 1; s < e.length; s++) {
      let o = e[s - 1], a = e[s], u = o[o.length - 1] >>> 2 & 1023,
          c = a[0] >>> 12;
    ...
    return t.map((s, o) => {
      ...
      let c = [];
      for (let [f, g] of u) {
        let l = e[f], m = l[0] >>> 12, x = l[l.length - 1] >>> 12,
        ...
        for (let y of g.sort((b, E) => E - b)) {
          ...
          d = [
            d.slice(0, b), "<mark>", d.slice(b, E), "</mark>", d.slice(E)
          ].join("")
        }
        if (a = x + v, c.push(d) === 2)
          break
  ...
  function he(t, e) {
    ...
    for (let s of r)
      (i = lunr.stopWordFilter) != null && i.call(lunr, s.term) &&
          (n[s.term] = !1);
    return n
  }
  function fe(t, e) {
  ...
  var H = class {
    constructor({config : e, docs: r, options: n}) {
      ...
      this.map = ie(r), this.options = n,
      this.index = lunr(function() {
        this.metadataWhitelist = [ "position" ], this.b(0),
        e.lang.length === 1 && e.lang[0] !== "en"
            ? this.use(lunr[e.lang[0]])
            : e.lang.length > 1 && this.use(lunr.multiLanguage(...e.lang)),
        this.tokenizer = ae, lunr.tokenizer.separator = new RegExp(e.separator),
        lunr.segmenter =
        ...
        for (let o of r)
          this.add(o, {boost : o.boost})
      })
    }
    search(e) {
      if (e = e.replace(new RegExp("\\p{sc=Han}+", "gu"),
                        s => [...fe(s, this.index.invertedIndex)].join("* ")),
          e = ce(e), !e)
        return {items : []};
      let r = le(e).filter(s => s.presence !== lunr.Query.presence.PROHIBITED),
          n = this.index.search(e)
                  .reduce(
                      (s, {ref : o, score : a, matchData : u}) => {
  ...
  function Ie(t) {
    return B(this, null, function*() {
      ...
      t.lang.length > 1 && r.push(`${e}/min/lunr.multi.min.js`),
          r.length && (yield importScripts(
                          `${e}/min/lunr.stemmer.support.min.js`, ...r))
    })
  }
  function Fe(t) {
    return B(this, null, function*() {
  ...
  addEventListener(
      "message",
      t => B(null, null, function*() { postMessage(yield Fe(t.data)) }));
})();
