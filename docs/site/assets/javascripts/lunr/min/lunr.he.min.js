    ...
    e.he.stemmer =
      ...
      return e.result = !1, e.preRemoved = !1, e.sufRemoved = !1, e.pre = {
        ...
        pre8 : "ובה ובו ובי ובת וכה וכו וכי וכת ולה ולו ולי ולת"
             ...
             e.execArray =
                 [
                   "cleanWord", "removeDiacritics", "removeStopWords",
